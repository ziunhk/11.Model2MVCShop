...
<head>
	...
	<script type="text/javascript">
		...
		//============= ajax이용 실시간 ID 중복 check ============
		//============= 'keyup' Event 처리 및  연결 =============
		$(function(){
			$("#userId").on("keyup", function(event){
				
				var checkId = $("input[name='userId']").val();
				$("#result_div").html("<p>사용가능</p>");
				
				$.ajax(
						{
							url : "/user/json/getUser/"+checkId, 
							method : "GET",
							dataType : "json", 
							headers : {
							...
							success : function(JSONData, status){
								...
								if(JSONData.userId == checkId){
									alert("checkId : \n"+checkId+"는 사용불가합니다.");
									$("#result_div").html("<p color='red'><strong>사용불가!!!!!</strong></p>");
								}
							}
						}
				)
	...
	<div class="container">
		...
		<form class="form-horizontal">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-3" id="result_div">
		    <!-- 
